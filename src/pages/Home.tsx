    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl w-full">
          ...
          <HomeCard onClick={() => navigate("/rotina")} borderColor="border-green-200 hover:border-green-400"
            gradientFrom="from-green-50" gradientTo="to-emerald-50" iconBg="bg-green-400/20" iconHoverBg="bg-green-400/30"
            IconComponent={CalendarCheck} iconColor="text-green-600" accentColor="text-green-600/70"
          ...
          <HomeCard onClick={() => navigate("/saude")} borderColor="border-red-200 hover:border-red-400"
            ...
            title="SAÚDE" description="Dieta, treinos, medidas, calorias, jejum e skincare"
          ...
          <HomeCard onClick={() => navigate("/estudos")} borderColor="border-blue-200 hover:border-blue-400"
